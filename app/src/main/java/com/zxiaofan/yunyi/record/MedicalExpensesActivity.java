...
import com.zxiaofan.yunyi.record.adapter.MyExpandableListAdapter1;
...
public class MedicalExpensesActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        String url = Constants.SERVER_ADDRESS+"medicalRecords-feedata/patient-"+Constants.getPatientId(this)+"?token=" + share.getPres("token");
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ToastUtil.ToastShow(MedicalExpensesActivity.this, "开发中...", true);
                pb.dismiss();
            }
        });
        queue.add(request);
