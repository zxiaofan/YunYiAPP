...
import com.zxiaofan.yunyi.record.adapter.MyExpandableListAdapter;
    ...
    private void initData() {
        ...
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ToastUtil.ToastShow(OutpatientPrescriptionsActivity.this, "开发中...", true);
                pb.dismiss();
            }
        });
        queue.add(request);
...
//                getChildData();
    ...
    public void initWidget() {
        MyExpandableListAdapter adapter = new MyExpandableListAdapter(this,lists);
        ...
        sr.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(OutpatientPrescriptionsActivity.this, "refresh", Toast.LENGTH_SHORT).show();
