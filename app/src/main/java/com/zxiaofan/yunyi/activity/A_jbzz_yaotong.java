 ...
 */
public class A_jbzz_yaotong extends Activity {
    String TAG = "A_jbzz_yaotong";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.jbzz_yaotong);
...
//                listSym.clear();
                ...
                if (listSym.isEmpty()) {
                    ToastUtil.show(A_jbzz_yaotong.this, "您尚未勾选任何症状！");
                } else {
                    api.queryDiseaseBySymptom(listSym.toString(), A_jbzz_yaotong.this);
                }
            }
        });
    }
