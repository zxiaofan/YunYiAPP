 ...
 */
public class A_jbzz_kesou extends Activity {
    String TAG = "A_jbzz_kesou";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.jbzz_kesou);
...
//                                listSym.remove((String) checkBox.getText());
                ...
                if (listSym.isEmpty()) {
                    ToastUtil.show(A_jbzz_kesou.this, "您尚未勾选任何症状！");
                } else {
                    api.queryDiseaseBySymptom(listSym.toString(), A_jbzz_kesou.this);
                }
            }
        });
    }
