 ...
 */
public class A_jbzz_houlongt extends Activity {
    String TAG = "A_jbzz_houlongt";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.jbzz_houlongt);
...
//                                listSym.remove((String) checkBox.getText());
                ...
                if (listSym.isEmpty()) {
                    ToastUtil.show(A_jbzz_houlongt.this, "您尚未勾选任何症状！");
                } else {
                    api.queryDiseaseBySymptom(listSym.toString(), A_jbzz_houlongt.this);
                }
            }
        });
    }
