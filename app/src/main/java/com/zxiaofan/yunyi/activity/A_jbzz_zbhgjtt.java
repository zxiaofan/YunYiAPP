 ...
 */
public class A_jbzz_zbhgjtt extends Activity {
    String TAG = "A_jbzz_zbhgjtt";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setContentView(R.layout.jbzz_zbhgjtt);
...
//                listSym.clear();
                ...
                if (listSym.isEmpty()) {
                    ToastUtil.show(A_jbzz_zbhgjtt.this, "您尚未勾选任何症状！");
                } else {
                    api.queryDiseaseBySymptom(listSym.toString(), A_jbzz_zbhgjtt.this);
                }
            }
        });
    }
